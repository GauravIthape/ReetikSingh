...
### 🔹 FocusLoop  
Productivity and habit-tracking platform with real-time analytics and scalable backend architecture.
Built using Java, Spring Boot, React, PostgreSQL, Redis, and Kafka.
<br>➡️ https://github.com/Reetiksingh

### 🔹 Diet Scanner (NutriLens)
Nutrition intelligence platform that converts food scans into dietary analytics, nutrition scoring, macro tracking, and personalized health insights through a scalable event-driven architecture.
<br>➡️ https://github.com/Reetiksingh  
